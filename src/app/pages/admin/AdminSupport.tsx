                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between mt-2">
                                            <span className="text-xs text-gray-400">
                                                ...
                                                {!ticket.user && ticket.guest_email && (
                                                    <span className="ml-1 text-purple-500">(Guest)</span>
                                                )}
                                            </span>
                                            <span className="text-xs text-gray-400">
                                ...
                                <div className="flex flex-col sm:flex-row items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1 break-all">
                                            From: {selectedTicket.user?.name || selectedTicket.guest_name || 'Guest'}
                                            {' '}({selectedTicket.user?.email || selectedTicket.guest_email})
                                            {!selectedTicket.user && (
                                                <span className="ml-2 px-2 py-0.5 text-xs bg-purple-100 text-purple-700 rounded-full">Contact Form</span>
                                            )}
                                        </p>
                                        {selectedTicket.guest_phone && (
                                            <p className="text-sm text-gray-500 mt-1">Phone: {selectedTicket.guest_phone}</p>
                                        )}
                                    </div>
                                    <select
                                ...
                                <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="font-medium text-gray-900">
                                            {selectedTicket.user?.name || selectedTicket.guest_name || 'Guest'}
                                        </span>
