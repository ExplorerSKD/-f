...
import { productsApi, reviewsApi, wishlistApi, Product, Review } from '../services/api';
...
export function ProductDetailPage() {
  ...
  useEffect(() => {
    const checkWishlist = async () => {
      ...
      const result = await wishlistApi.check(parseInt(id));
      if (result.success && result.data) {
        setWishlist(result.data.in_wishlist);
      }
    };
    checkWishlist();
  }, [id, isAuthenticated]);
