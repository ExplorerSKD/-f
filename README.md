...
- ✅ **Subcategory filtering** in shop page
- ✅ Shopping cart with quantity management
- ✅ **Buy Now** for instant checkout
- ✅ Wishlist functionality (persisted to backend)
...
- ✅ **Contact form** (creates support ticket for guests)

### Admin Features
- ✅ Dashboard with analytics & reporting
- ✅ Product management with **Image Upload**
- ✅ **Nested Categories (Subcategories)** management
- ✅ **Subcategory selection** in Add/Edit Product modal
...
- ✅ FAQ management
- ✅ Support ticket handling (including **guest tickets from contact form**)
- ✅ User management
- ✅ Global settings (Sensitive keys moved to .env for security)
- ✅ **Mobile-responsive** admin panel with card views

### Mobile Responsiveness
- ✅ **Shop page filter button** - Slide-out filter panel on mobile
- ✅ **Profile page menu button** - Slide-out navigation menu on mobile
...
| GET | `/faqs` | Get FAQs |
| POST | `/contact` | Submit contact form (creates guest ticket) |
...
| GET | `/admin/support` | List support tickets (user + guest) |
...
- **Products** - Product management (with subcategory selection)
- **Categories** - Category organization (parent/child hierarchy)
...
- **Support** - Customer ticket handling (including guest tickets)
...
### Customer Pages
- **Shop Page** - Filter button reveals slide-out filter panel
- **Profile Page** - Menu button reveals slide-out navigation
- **Product Detail** - Responsive image gallery and actions
...
1. Ensure you are logged in before adding to wishlist
2. Check that the product detail page calls the wishlist API
...
### v2.0.0
- ✅ Added subcategory filter section in Shop page
- ✅ Mobile slide-out filters on Shop page
- ✅ Mobile slide-out menu on Profile page
- ✅ Subcategory selection in Admin Products modal
- ✅ Contact form integration with Support Tickets
- ✅ Guest ticket support in Admin panel
- ✅ Wishlist API integration on Product Detail page
